"""
URL configuration for emteegee project.
...
urlpatterns = [
    ...
    # path('', include('cards.urls')),  # Main cards.urls has import issues    path('api/swarm/', include('cards.api_urls')),  # Original Swarm API - v1.0
